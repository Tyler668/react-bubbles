...
A token is a unique identifier which requests access to a server or service, it usually takes the form of a string or .json and works as a sort of key that will coincide with relavant / personal server data or access.  

- [ ] What steps can you take in your web apps to keep your data secure?

Private routes can be used along with an authentication system for useers so that only once a user  has signed in with valid credentials can they access a certain address and see certain content.

- [ ] Describe how web servers work.

Web browsers request content from the server with a unique URL that points to the correct site, the server recieves this and proceeds to serve the browser / user with relevant content.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Create - POST - Add new things to server
Read - GET - See what's on the server 
Update - PUT - Change server data
Delete - DELETE - Delete server data
